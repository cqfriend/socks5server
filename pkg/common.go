...
var (
	...
	errUDPAssociateDisabled = errors.New("udp associate is disabled, use udp over tcp instead")
	errUDPOverTCPDisabled   = errors.New("udp over tcp is disabled, use udp associate instead")
	errUDPDisabled          = errors.New("udp is disabled")
)
